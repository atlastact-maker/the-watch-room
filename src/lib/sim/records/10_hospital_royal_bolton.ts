...
// officer himself, the ward 19 inpatient whose home-oxygen notification
// puts her on the desk (she is the sim's hidden casualty — the record
// does not say so), the ward and trust staff the informant script has
// talking, and the trust fleet vans on the internal road. Every person
// and vehicle here is fictional; the streets are real, the house numbers
// are not.
...
export const records10: RecordSet = {
  ...
  people: [
    ...
    },
    {
      ...
      scenarioId: "10",
      notes: [
        "Trust fire team, second responder — on Block C 3rd floor with the duty fire officer; reporting back by radio.",
        "Checking the Block C 3rd floor compartment doors, ward 19/20 junction first.",
      ],
    },
    {
    ...
    },
    {
      ...
      notes: [
        ...
        "Holds keys for the ward electrical distribution boards and the VIE compound gate.",
      ],
    },
    {
      id: "p10-itu-walsh",
      ...
      scenarioId: "10",
      notes: [
        "ITU nurse in charge, Block D — across the link corridor from Block C; Stage 1, defend in place, under the trust's staged policy.",
  ...
  places: [
    ...
    },
    {
      ...
      notes: [
        ...
        "Not a fire service RVP — kept clear for HEMS and for patient moves beyond Stage 2.",
      ],
    },
    {
