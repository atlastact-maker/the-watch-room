...
export const records08: RecordSet = {
  ...
  people: [
    ...
    },
    {
      ...
      markers: ["CHILD"],
      notes: [
        "Evening swim squad member — instructor believes he went back into the changing rooms for his phone.",
    ...
    },
    {
      ...
      roles: ["keeper"],
      notes: [
        "Parent of HALLIWELL, Owen (swim squad). Expected on the front car park with the other parents.",
      ],
      scenarioId: "08",
  ...
  vehicles: [
    ...
    },
    {
      ...
      notes: ["Parent's car — expected on the school access road with the other arriving parents."],
      scenarioId: "08",
    },
  ],
