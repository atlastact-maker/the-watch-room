...
const TILE_BUTTONS: { id: TileId; label: string; needsIncident?: boolean }[] = [
  ...
  { id: "subject", label: "Subject vehicle", needsIncident: true },
...
export function VectorDesk(props: {
  ...
  /** The subject vehicle the job is chasing — reads, track, tactics. */
  subjectTile?: (area: { w: number; h: number }, pop: PopProps) => ReactNode;
  map: ReactNode;
  mapTitle: string;
  mapExtras?: ReactNode;
        ...
        <>
          ...
          <div className="vec-workspace">
            ...
            <div className="vec-map-area" ref={areaRef}>
              ...
              {tiles.subject && hasIncident && props.subjectTile?.(area, pop("subject"))}
