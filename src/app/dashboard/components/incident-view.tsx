...
export function IncidentView({
  ...
  return (
    <div className="absolute inset-0 z-[1200] flex flex-col bg-(--color-bg)">
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden bg-(--color-bg)">
          <GroundSceneMap
            incident={incident}
            resolved={resolved}
...
function taskLabelShort(kind: TaskKind): string {
  switch (kind) {
    ...
    case "bridgehead": return "Bridgehead";
    case "firefighting_lift": return "FF Lift";
    case "evacuate_floors": return "Evacuate";
    case "hazmat_identify": return "DIM";
    case "decontaminate": return "Decon";
